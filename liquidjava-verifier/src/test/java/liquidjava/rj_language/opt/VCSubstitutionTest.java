...
class VCSubstitutionTest {
    ...
    void substitutesBinderEqualityIntoWholeChain() {
        ...
        assertSimplificationSteps(VCSubstitution::apply, implication, chain(expect("3 > 0", "∀x:int. x > 0")));
    }
    ...
    void substitutesCompoundKnownValue() {
        ...
        assertSimplificationSteps(VCSubstitution::apply, implication, chain(expect("y + 1 > y", "∀x:int. x > y")));
    }
    ...
    void substitutesOnlyWholeVariableReferences() {
        ...
        assertSimplificationSteps(VCSubstitution::apply, implication, chain(expect("xx > 3", "∀x:int. xx > x")));
    }
    ...
    void substitutesEveryOccurrenceInPredicate() {
        ...
        assertSimplificationSteps(VCSubstitution::apply, implication, chain(expect("2 + 2 > 0", "∀x:int. x + x > 0")));
    }
    ...
    void preservesRemainingBinderAfterSubstitution() {
        ...
        assertSimplificationSteps(VCSubstitution::apply, implication,
    ...
    void removesSourceNodeWhenItIsLastInChain() {
        ...
        assertSimplificationSteps(VCSubstitution::apply, implication, chain(expect("x > 0", "x > 0")));
    }
    ...
    void substitutesInnerKnownValueAcrossNestedImplications() {
        ...
        assertSimplificationSteps(VCSubstitution::apply, implication, chain(expect("true", "∀x:int. true"),
